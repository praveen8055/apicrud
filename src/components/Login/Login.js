...
import logoAppreaz from "../../assets/logoApperaz.png";
  ...
  return (
    <>
      <p
        ...
        className={`absolute top-4 right-4 text-xs underline ${classes.createAccountMessage}`}
        style={{ cursor: "pointer" }}
      >
        Don't have an appereaz account?
      </p>
      <div>
        <img src={logoAppreaz} className="absolute top-0 left-0"></img>
        <p className={`absolute top-6 left-12 ${classes.logoName}`}>APPREAZ</p>
      </div>
      <div className="w-screen h-screen flex items-center">
        <div className="w-1/2 flex flex-col items-center justify-center">
          ...
          <button
            className={`w-1/4 h-8 rounded-3xl text-white mb-5 text-sm font-medium ${classes.cloudButton}`}
          >
            WATCH VIDEO
          </button>
        </div>
        <div
          className={`w-1/2 h-screen flex flex-col items-center justify-center ${classes.backgroundLoginColor}`}
        >
          ...
          <div className="flex flex-col items-center">
            <button
              className={`w-60 h-8 rounded-3xl text-white mb-6 font-medium ${classes.loginButton}`}
            ...
            >
              <img className="mr-2 w-4 h-4" src={googleImage}></img>
            ...
            <button className="flex items-center justify-center w-64 h-8 rounded-3xl border border-blue-700 text-blue-700">
              <img className="mr-2 w-5 h-5" src={facebookImage}></img>
