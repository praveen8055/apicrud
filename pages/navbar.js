    ...
    return (
        <div>
            ...
            <div style={{width:"120px"}} className="fixed h-full bg-indigo-900 md:flex flex-col hidden">
                ...
                <div className="flex flex-col w-full justify-center items-center py-4 mb-2 bg-white cursor-pointer cursor-pointer" >
                ...
                <div className="flex flex-col w-full justify-center mb-2 items-center py-4 bg-white cursor-pointer" >
                    ...
                    <div className="text-white font-extrabold group-hover:text-indigo-900">Contact</div></div>
                )
                }
                </Link>
            ...
            {profile && 
                <div className="absolute right-16 top-20  z-30 bg-white rounded-md ">
                <div className="flex flex-row ">
                    <IoPersonSharp className="mt-4 ml-2 text-gray-400 h-8 w-8 pt-1 bg-gray-100 pb-2 rounded-md " />
                    <p className="pl-5 pt-3 ">Jonathan Philip</p>
